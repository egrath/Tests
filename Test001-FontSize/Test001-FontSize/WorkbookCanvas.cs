...
namespace Test001
{
    internal sealed class WorkbookCanvas : Panel
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            // Grid zeichnen
            Pen gridPen = new Pen(new SolidBrush(Color.FromArgb(232, 232, 232)), m_GridLineStrength);
            ...
            // Cursor zeichnen
            Point coord = CoordinatesForWorkbookPosition(m_Workbook.CursorPosition.X, m_Workbook.CursorPosition.Y);
            coord.X -= m_FontPadding / 2;
            coord.Y -= m_FontPadding / 2;
            Pen cursorPen = new Pen(Brushes.DarkOrange, m_GridLineStrength * 2);
            g.DrawRectangle(cursorPen, new Rectangle(coord, new Size(m_FontDimension.Width + m_FontPadding + m_GridLineStrength, m_FontDimension.Height + m_FontPadding + m_GridLineStrength)));
        }
    }
}